 // js para activar la animación de desplazamiento
 window.onload = function () {
    ...
    // Busca un elemento con la clase 'contenido-tarjetas'
    const tarjetasContenido = document.querySelector('.contenido-tarjetas');

    // Si se encuentra el elemento
    if (tarjetasContenido) {
        // Aplica una animación llamada 'desplazamiento' al elemento encontrado
        tarjetasContenido.style.animation = 'desplazamiento 50s linear infinite';
    }
}